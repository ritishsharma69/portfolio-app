...
const projects = [
  { id: 'khushiya', title: 'Khushiya Store', desc: 'E‑commerce platform (MERN)', stack: ['React', 'Node', 'MongoDB'], to: '/projects' },
  { id: 'restaurant', title: 'Restaurant Booking App', desc: 'MERN booking system', stack: ['React', 'Node', 'MongoDB'], to: '/projects' },
  { id: 'news', title: 'News App', desc: 'Angular + Ionic mobile app', stack: ['Angular', 'Ionic'], to: '/projects' },
];
